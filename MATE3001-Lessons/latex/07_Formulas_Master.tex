...
\newcommand{\lessontitle}{Fórmulas}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/07_formulas/}}
...
\input{includes/07_Formulas_Content}
\input{includes/07_Formulas_Exercises}

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/07_Formulas_Solutions}
\fi
