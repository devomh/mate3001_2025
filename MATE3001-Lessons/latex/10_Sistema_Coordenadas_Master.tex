...
\newcommand{\lessontitle}{Sistema de Coordenadas}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/10_sistema_coordenadas/}}
...
\input{includes/10_Sistema_Coordenadas_Content}
\input{includes/10_Sistema_Coordenadas_Exercises}

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/10_Sistema_Coordenadas_Solutions}
\fi
