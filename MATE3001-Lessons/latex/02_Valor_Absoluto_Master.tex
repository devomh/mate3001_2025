...
\newcommand{\lessontitle}{Valor Absoluto y Leyes de Signos}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/02_valor_absoluto/}}
...
\input{includes/02_Valor_Absoluto_Content}         
\input{includes/02_Valor_Absoluto_Exercises}       

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/02_Valor_Absoluto_Solutions}
\fi
