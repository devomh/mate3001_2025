...
\begin{tikzpicture}[scale=0.8]
    % Quadrant I
    \node[draw, fill=green!15, minimum width=2.5cm, minimum height=2cm, rounded corners] at (0,0) {
        \textbf{Cuadrante I} \\[0.2cm]
        $(+, +)$ \\
        $x > 0, y > 0$
    };

    % Quadrant II
    \node[draw, fill=blue!15, minimum width=2.5cm, minimum height=2cm, rounded corners] at (3.5,0) {
        \textbf{Cuadrante II} \\[0.2cm]
        $(-, +)$ \\
        $x < 0, y > 0$
    };

    % Quadrant III
    \node[draw, fill=orange!15, minimum width=2.5cm, minimum height=2cm, rounded corners] at (0,-2.8) {
        \textbf{Cuadrante III} \\[0.2cm]
        $(-, -)$ \\
        $x < 0, y < 0$
    };

    % Quadrant IV
    \node[draw, fill=red!15, minimum width=2.5cm, minimum height=2cm, rounded corners] at (3.5,-2.8) {
        \textbf{Cuadrante IV} \\[0.2cm]
        $(+, -)$ \\
        $x > 0, y < 0$
    };
\end{tikzpicture}
