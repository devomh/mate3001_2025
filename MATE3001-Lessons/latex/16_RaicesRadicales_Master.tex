...
\newcommand{\lessontitle}{Raíces y Radicales}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/16_raices_radicales/}}
...
\input{includes/16_RaicesRadicales_Content}
\input{includes/16_RaicesRadicales_Exercises}

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/16_RaicesRadicales_Solutions}
\fi
