...
\newcommand{\lessontitle}{Conjuntos y Operaciones con Conjuntos}    % Will be overridden per lesson
...
\input{includes/01_Conjuntos_Content}         
\input{includes/01_Conjuntos_Exercises}       

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/01_Conjuntos_Solutions}
\fi
