...
\newcommand{\lessontitle}{Propiedades de los Números Reales y Exponentes}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/03_propiedades_reales/}}
...
\input{includes/03_Propiedades_Reales_Content}         
\input{includes/03_Propiedades_Reales_Exercises}       

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/03_Propiedades_Reales_Solutions}
\fi
