...
\newcommand{\lessontitle}{Expresiones Algebraicas y Polinomios}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/04_expresiones_algebraicas/}}
...
\input{includes/04_Expresiones_Algebraicas_Content}         
\input{includes/04_Expresiones_Algebraicas_Exercises}       

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/04_Expresiones_Algebraicas_Solutions}
\fi
