...
\newcommand{\lessontitle}{Factorización y Evaluación de Polinomios}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/05_factorizacion_evaluacion/}}
...
\input{includes/05_Factorizacion_Evaluacion_Content}         
\input{includes/05_Factorizacion_Evaluacion_Exercises}       

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/05_Factorizacion_Evaluacion_Solutions}
\fi
