...
\newcommand{\lessontitle}{Expresiones Racionales}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/14_expresiones_racionales/}}
...
\input{includes/14_ExpresionesRacionales_Content}
\input{includes/14_ExpresionesRacionales_Exercises}

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/14_ExpresionesRacionales_Solutions}
\fi
