...
\newcommand{\lessontitle}{Funciones}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/17_funciones/}}
...
\input{includes/17_Funciones_Content}
\input{includes/17_Funciones_Exercises}

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/17_Funciones_Solutions}
\fi
