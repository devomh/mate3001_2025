...
\newcommand{\lessontitle}{Problemas Verbales}    % Will be overridden per lesson
...
%========================================
\graphicspath{{../images/}{../images/shared/}{../images/diagrams/}{../images/09_problemas_verbales/}}
...
\input{includes/09_Problemas_Verbales_Content}
\input{includes/09_Problemas_Verbales_Exercises}

% Conditional solution inclusion
\ifshowsolutions
    \newpage
    \section*{Soluciones}
    \input{includes/09_Problemas_Verbales_Solutions}
\fi
